...
def get_arguments():
    ...
    parser.add_argument('--test_dir', default=None, help='set the save dir for testing')
    parser.add_argument('--weight_path', default=None, help='loading lora weight from the path')
